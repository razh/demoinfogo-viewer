...
export function parse( file ) {
  ...
  if ( options.lighting ) {
    ...
    var lightingHDR = readLumpData(
      reader,
      lightingHDRLump,
      ColorRGBExp32.read
    );
    bsp.lightingHDR = lightingHDR;
    if ( options.debug ) {
